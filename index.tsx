...
- Output Structure: For CFD models, set "model_type" to "CFD" and include a "simulation_data" object describing the setup.
...
// CFD Example
{
  ...
  "description": "Simulation of airflow over a cylinder at 10 m/s",
  ...
  "simulation_data": {
    ...
    "boundary_conditions": [
      ...
      { "name": "cylinder_wall", "type": "no-slip_wall" },
...
\nDefault Unit System: ${defaultUnitSystem === 'Metric' ? 'mm' : 'in'}`;
      ...
      const imagePrompt = `Photorealistic 3D CAD render of: ${convertedPrompt}. ${materialParams.trim() ? `Material: ${materialParams}.` : ''} ${fourDParams.trim() ? `Animation details: ${fourDParams}.` : ''} ${cfdParams.trim() ? `CFD simulation visualization: ${cfdParams}.` : ''} Professional studio lighting, detailed, high-resolution, on a neutral background.`;
      ...
      <div className="card">
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            placeholder="e.g., fluid is air at 20C, inlet velocity 10 m/s on the left face..."
            disabled={isLoading}
